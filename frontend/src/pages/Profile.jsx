...
function Profile() {
    ...
    function handlePasswordSave(e) {
        ...
        if (!pw.old_password || !pw.new_password || !pw.confirm) {
        ...
        setPwLoading(true);
        updatePassword({old_password: pw.old_password, new_password: pw.new_password})
            .then(() => {
    ...
    // group saved recipes by cuisine for the pie chart
                    ...
                    <div className="bg-white rounded-xl border border-stone-200 p-6">
                        ...
                        {cuisineData.length === 0 ? (
                            ...
                            <ResponsiveContainer width="100%" height={220}>
                                <PieChart>
                                    <Pie data={cuisineData} cx="50%" cy="50%" outerRadius={75} paddingAngle={3} dataKey="value">
                                        {cuisineData.map((_, i) => (
