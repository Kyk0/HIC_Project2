    ...
    return (
        <>
            ...
            <section className="bg-orange-50 px-6 pt-20 pb-24">
                <div className="max-w-6xl mx-auto grid grid-cols-12 gap-16 items-center">

                    <div className="col-span-6">

                        <FadeIn>
                            <h1 className="text-6xl font-serif text-stone-800 leading-tight mb-6">
                    ...
                    <FadeIn delay={0.2} className="col-span-6">
            ...
            <section className="bg-white py-16 border-y border-stone-100">
                ...
                <FadeIn inView>
                    <div className="text-center mb-10 px-6">
                        <h2 className="text-4xl font-serif text-stone-800">From our collection</h2>
                    </div>
                </FadeIn>
                    ...
                    <div className="animate-marquee flex gap-6 px-3 whitespace-nowrap">
                        {duped.map((r, i) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-stone-900 to-transparent flex items-end p-4">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <FadeIn inView>
                        <div className="text-center mb-14">
                            <h2 className="text-4xl font-serif text-stone-800 mb-4">Everything in one place</h2>
                        </div>
                    </FadeIn>
            ...
            <section className="bg-white px-6 py-24 border-t border-stone-100">
                <div className="max-w-6xl mx-auto grid grid-cols-2 gap-16 items-start">
                    ...
                    <FadeIn inView>
                        ...
                        <h2 className="text-4xl font-serif text-stone-800 mb-3">A look inside</h2>
                        ...
                        <div className="flex flex-col gap-3">
                            {tabs.map((tab, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <h3 className={"text-lg font-serif mb-0.5 " + (active ? "text-orange-700" : "text-stone-700")}>
                                            {tab.title}
                                        </h3>
