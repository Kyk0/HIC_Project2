...
function Contact() {
    ...
    if (submitted) {
        return (
            <div className="min-h-screen bg-orange-50 pt-24 pb-16 px-8 flex flex-col items-center justify-center text-center">
    ...
    return (
        <div className="min-h-screen bg-orange-50 flex flex-col justify-center items-center px-8 py-24">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-stone-200 p-8 flex flex-col gap-5 w-full max-w-lg">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="self-center px-6 py-2.5 bg-orange-600 text-white rounded-lg text-sm font-medium hover:bg-orange-700 disabled:opacity-50"
                >
